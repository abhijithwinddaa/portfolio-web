  ...
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
      ...
      <div className="relative w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
        ...
        <img
          src="/pic1.JPG" // USE YOUR DIRECT LINK HERE!
          alt="Abhijith's Profile Picture"
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Highly motivated and technically proficient MCA graduate with a passion for software development and a strong foundation in computer science concepts. Experienced in various programming languages, database management systems, and web development technologies. Skilled in problem-solving, teamwork, and communication. Eager to leverage academic knowledge and practical experience to contribute to innovative projects and excel in the field of technology.
            </p>
          </div>
